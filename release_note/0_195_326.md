...
Cmd+Z キー入力（修正後）
│
├─► 【VSCode】keybinding が fractal.undo にマッチ
...
| ファイル | 変更内容 |
| --- | --- |
| `package.json` | `fractal.undo`/`redo`コマンド定義。`activeCustomEditorId == 'fractal.editor'`条件でCmd+Z/Cmd+Shift+Z/Cmd+Yのキーバインドをオーバーライド |
